...
const Terminal = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      output: [
        'Hello 👋',
        '\nFawwaz is an Information Engineering student at Universitas Gadjah Mada with a strong foundation in Computer Vision, Data Engineering, IoT, Cybersecurity, and Software Engineering. He has diverse hands-on experience, from front-end development to creating Capture The Flag problems. Currently, Fawwaz works as a Vision and Control Programmer at GAMAFORCE, a UAV-focused research group, specializing in Computer Vision and AI for their Ground Control Station team.',
        '\nKnow me better from:'
      ],
      type: true,
              ...
              <div key={index} className="mb-2">
                ...
                {step.showSocialLinks && (
                  <div className="flex flex-col items-start mt-2 ml-2">
                    <a href="https://www.linkedin.com/in/sfawwazak/" target="_blank" rel="noopener noreferrer" className="text-blue-500">
                      <FaLinkedin className="inline-block mr-1" /> LinkedIn
                    </a>
                    <a href="https://github.com/fawwazak" target="_blank" rel="noopener noreferrer" className="text-gray-500">
                      <FaGithub className="inline-block mr-1" /> GitHub
                    </a>
                    <a href="https://instagram.com/sfawwazak" target="_blank" rel="noopener noreferrer" className="text-[#D3448C]">
